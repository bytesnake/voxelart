/*
 * Achtung vor Release und veröffentlichung muss das hier ersetzt werden
 * Dies steht unter der GPL Lizens und ist je nach der ausgewählten, inkompatible 
 * Der Source stammt von dem Mineserver
*/
